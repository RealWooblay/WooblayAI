/**
 * SVG icon components for the Wooblay UI.
 * All icons are 20x20 by default, stroke-based for consistency.
 */
...
export function IconVerified(props: IconProps) {
  return (
    <Icon {...props}>
      <path d="M12 2 L14.5 8.5 L21.5 9 L16.5 14 L18 21 L12 17.5 L6 21 L7.5 14 L2.5 9 L9.5 8.5 Z" fill="currentColor" strokeWidth={0} />
      <path d="m9 12 2 2 4-4" stroke="white" strokeWidth={2} />
    </Icon>
  );
}

// Zap / Lightning for velocity
export function IconZap(props: IconProps) {
  return (
    <Icon {...props}>
      <path d="M4 14a1 1 0 0 1-.78-1.63l9.9-10.2a.5.5 0 0 1 .86.46l-1.92 6.02A1 1 0 0 0 13 10h7a1 1 0 0 1 .78 1.63l-9.9 10.2a.5.5 0 0 1-.86-.46l1.92-6.02A1 1 0 0 0 11 14z" fill="currentColor" stroke="none" />
    </Icon>
  );
}
